...
function socialLinksMarkup() {
  return `
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 4px;border-collapse:separate;border-spacing:0 10px;">
      ${SOCIAL_LINKS.map(
        ({ label, href }) => `
          <tr>
            <td>
              <a
                ...
                style="display:block;padding:12px 16px;border-radius:14px;background:#0f241a;border:1px solid #244233;color:#f5fbf7;text-decoration:none;font-size:15px;font-weight:700;line-height:1.4;"
              >
                Abrir ${label}
              </a>
            </td>
